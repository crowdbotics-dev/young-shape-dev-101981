"""
Django settings for young_shape_dev_101981 project.
...
ROOT_URLCONF = 'young_shape_dev_101981.urls'
...
WSGI_APPLICATION = 'young_shape_dev_101981.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "young_shape_dev_101981 API",
    "DESCRIPTION": "API documentation for young_shape_dev_101981 App",
    "VERSION": "v1",
}
